(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amdx ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.WebMCP = {}));
  ...
  (function(exports3) {
    ...
    class Ajv2 {
      constructor(opts = {}) {
        ...
        if (opts.formats)
          addInitialFormats2.call(this);
        this._addVocabularies();
        this._addDefaultMetaSchema();
        if (opts.keywords)
          addInitialKeywords2.call(this, opts.keywords);
      ...
      _addSchema(schema, meta, baseId, validateSchema2 = this.opts.validateSchema, addSchema2 = this.opts.addUsedSchema) {
        let id2;
        const { schemaId } = this.opts;
        if (typeof schema == "object") {
          id2 = schema[schemaId];
    ...
    function getMetaSchemaOptions2() {
      ...
      for (const opt of META_IGNORE_OPTIONS2)
        delete metaOpts[opt];
      return metaOpts;
    }
    const noLogs = { log() {
  ...
  (function(module2, exports3) {
    ...
    class Ajv2 extends core_12.default {
      ...
      defaultMeta() {
        return this.opts.defaultMeta = super.defaultMeta() || (this.getSchema(META_SCHEMA_ID2) ? META_SCHEMA_ID2 : void 0);
      }
    }
    exports3.Ajv = Ajv2;
  ...
  function compile$1(schema, root, localRefs, baseId) {
    ...
    function localCompile(_schema, _root, localRefs2, baseId2) {
      ...
      sourceCode = vars(refVal, refValCode) + vars(patterns, patternCode) + vars(defaults2, defaultCode) + vars(customRules, customRuleCode$1) + sourceCode;
...
` && searchIndex++;
  ...
  */
    ...
    _scheduleReconnection(options, attemptCount = 0) {
      ...
      setTimeout(() => {
        this._startOrAuthSse(options).catch((error2) => {
          var _a2;
          (_a2 = this.onerror) === null || _a2 === void 0 ? void 0 : _a2.call(this, new Error(`Failed to reconnect SSE stream: ${error2 instanceof Error ? error2.message : String(error2)}`));
  ...
  function parseArrayDef(def2, refs) {
    ...
    if (((_a = def2.type) == null ? void 0 : _a._def) && ((_c = (_b = def2.type) == null ? void 0 : _b._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind.ZodAny) {
...
` : `[${source[i]}\r
  ...
  function parseRecordDef(def2, refs) {
    ...
    if (refs.target === "openApi3" && ((_a = def2.keyType) == null ? void 0 : _a._def.typeName) === ZodFirstPartyTypeKind.ZodEnum) {
      return {
        type: "object",
    ...
    if (((_b = def2.keyType) == null ? void 0 : _b._def.typeName) === ZodFirstPartyTypeKind.ZodString && ((_c = def2.keyType._def.checks) == null ? void 0 : _c.length)) {
    ...
    } else if (((_e = def2.keyType) == null ? void 0 : _e._def.typeName) === ZodFirstPartyTypeKind.ZodBranded && def2.keyType._def.type._def.typeName === ZodFirstPartyTypeKind.ZodString && ((_f = def2.keyType._def.type._def.checks) == null ? void 0 : _f.length)) {
  ...
  function parseDef(def2, refs, forceResolution = false) {
    ...
    if (refs.override) {
      const overrideResult = (_a = refs.override) == null ? void 0 : _a.call(refs, def2, refs, seenItem, forceResolution);
