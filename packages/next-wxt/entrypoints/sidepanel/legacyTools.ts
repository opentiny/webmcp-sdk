...
import type { BuiltinExtensionTool } from './extraTools'

/**
 * 包含旧版的无障碍解析、视觉模型操作以及页面文本提取工具。
 * 这些工具暂时在主流程中停用，但保留逻辑以备后续参考或恢复。
 */
export const getLegacyExtensionTools = (): BuiltinExtensionTool[] => {
  return [
    // ─────────────────── 获取页面文本信息 ───────────────────
    {
