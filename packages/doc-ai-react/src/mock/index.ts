...
// State
export let inventoryList: InventoryItem[] = [...initialInventory]
export let priceProtectionList: PriceProtectionOrder[] = [...initialPriceProtectionOrders]
...
export const orderList: OrderItem[] = [...initialOrders]
