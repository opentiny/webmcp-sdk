...
export function generateImportMap(options: ImportMapOptions) {
  ...
  const importMap: ImportMap = {
    imports: {
      ...
      // nextSdk 相关包 - 使用统一版本号
      '@opentiny/next-sdk': `https://cdn.jsdelivr.net/npm/@opentiny/next-sdk@0.1.15/dist/webmcp-full.es.js`,
      '@opentiny/next-remoter': `https://cdn.jsdelivr.net/npm/@opentiny/next-remoter@0.0.10-beta.7/dist/next-remoter-runtime.es.js`,
