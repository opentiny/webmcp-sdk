    ...
    <div class="page-content">
      ...
      <tiny-grid
        ...
        :tiny_mcp_config="{
          ...
          business: { id: 'product-status', description: '按状态商品列表' }
        }"
      >
...
import type { Product, ProductStatus } from '../../../skills/product-management'
...
const activeStatus = ref<ProductStatus>('on')

const filteredByStatus = computed(() =>
  sourceData.value.filter((p) => p.status === activeStatus.value)
)
